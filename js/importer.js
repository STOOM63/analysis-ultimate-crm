  ...
  function parseCsv(file, onProgress) {
    return new Promise((resolve, reject) => {
      ...
      Papa.parse(file, {
        ...
        worker: true,
        dynamicTyping: false,
        // IMPORTANT: ne pas utiliser transformHeader avec worker:true.
        // Papa Parse transmet la configuration au Web Worker via structured clone ;
        // une fonction dans la configuration provoque notamment sous Firefox :
        // "Function object could not be cloned."
        // Les en-têtes sont normalisés juste après le parsing par canonicalHeaders().
