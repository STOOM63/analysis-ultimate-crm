...
AU.APP = Object.freeze({
  name: 'Analysis Ultimate',
  company: 'Basalte-Web',
  version: '3.1.0 ULTIMATE GEO API SENTINEL',
  dataPolicy: 'Traitement local dans le navigateur — aucune donnée client n’est envoyée par Analysis Ultimate.'
});
